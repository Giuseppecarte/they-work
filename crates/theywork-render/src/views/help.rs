...
pub(crate) fn draw(frame: &mut Frame, scroll: &mut usize) {
    ...
    let entries = [
        ...
        "Arrows / hjkl select · Tab / Shift-Tab cycles floors.",
        ...
        "Read details here; answer or approve in the source app.",
        ...
        "Desk: Home oldest · End latest (history times are UTC).",
        "s customizes · v camera · o room palette · O restore.",
        "Desk: w character · W original. Traits are fictional.",
        "c connects local sources and offers to remember choices.",
        "Local records are read-only; no extra login is required.",
