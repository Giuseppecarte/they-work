# Iteration 8: five-person discovery study

**Status: prepared; 0 of 5 sessions conducted. All participant outcomes are
not tested.** The iteration 7 workflow evidence is an expert inspection of a native
...
[protocol](PROTOCOL.md), [task cards](TASKS.md), [blank baseline scorecard](scorecard.csv), [optional follow-up scorecard](followup-scorecard.csv),
...
The [approved gates](GATES.md) take precedence over the historical kit: one fixed
baseline through all five sessions and any diaries; optional 20-minute follow-ups
with the same five; at most one qualifying prototype per UX item. Actual launcher
preflight is recorded separately in [PREFLIGHT.md](PREFLIGHT.md); the
[REPRO smoke](../../../AUDIT.md) does not validate this study tooling.
...
- Historical iteration 7 evidence (its recorded binary, not this candidate): state/reading/action separation, retained
  result versus visit baseline, current shortcut destinations and three
  presentation conditions. See [workflow report](../../iteration-7/workflows/REPORT.md).
...
navigation issue is a roadmap candidate when at least two distinct participants encounter
...
This kit was adapted from the preserved [iteration 7 kit](../../iteration-7/study/README.md).
No historical participant outcome or test result has been copied as new evidence.
